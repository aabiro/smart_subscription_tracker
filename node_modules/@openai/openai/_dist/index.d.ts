 ...
 */ export declare class OpenAI extends Core.APIClient {
  ...
  static OpenAIError: any;
  static APIError: any;
  static APIConnectionError: any;
  static APIConnectionTimeoutError: any;
  static APIUserAbortError: any;
  static NotFoundError: any;
  static ConflictError: any;
  static RateLimitError: any;
  static BadRequestError: any;
  static AuthenticationError: any;
  static InternalServerError: any;
  static PermissionDeniedError: any;
  static UnprocessableEntityError: any;
  static toFile: any;
  static fileFromPath: any;
}
...
/** API Client for interfacing with the Azure OpenAI API. */ export interface AzureClientOptions extends ClientOptions {
  /**
...
/** API Client for interfacing with the Azure OpenAI API. */ export declare class AzureOpenAI extends OpenAI {
  private _azureADTokenProvider: any;
   ...
   * @param {Core.DefaultQuery} opts.defaultQuery - Default query parameters to include with every request to the API.
   * @param {boolean} [opts.dangerouslyAllowBrowser=false] - By default, client-side use of this library is not allowed, as it risks exposing your secret API credentials to attackers.
   */ constructor({}?: AzureClientOptions);
  override buildRequest(options: Core.FinalRequestOptions<unknown>, props?: {
    retryCount?: number;
  }): {
    req: RequestInit;
    url: string;
  ...
  protected override authHeaders(opts: Core.FinalRequestOptions): Core.Headers;
  protected override prepareOptions(opts: Core.FinalRequestOptions<unknown>): Promise<void>;
}
